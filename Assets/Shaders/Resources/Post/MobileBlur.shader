...
Shader "Hidden/FastBlur" {
	...
	CGINCLUDE
		...
		v2f_tap vert4Tap ( appdata_img v )
		{
			...
			//float2 texbase = v.texcoord.yx * _Crop.xy + _Crop.zw;

			float2 texbase = v.texcoord.xy * float2(1,1) + float2(0,0);

        	o.uv20 = texbase + _MainTex_TexelSize.xy;				
			o.uv21 = texbase + _MainTex_TexelSize.xy * half2(-0.5h,-0.5h);	
			o.uv22 = texbase + _MainTex_TexelSize.xy * half2(0.5h,-0.5h);		
			o.uv23 = texbase + _MainTex_TexelSize.xy * half2(-0.5h,0.5h);		
